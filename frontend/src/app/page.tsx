          ...
          <h1 className="text-[20px] font-bold m-10" >Bạn Đang Quan Tâm  Gì?</h1> 
            <div className="m-10 flex gap-10 flex-wrap">
                {topicList.map((topic)=>(
                  ...
                  style={
                        {
                          // truyền màu vào biến CSS
                          ['--from' as any]: topic.bg_color.bg_color_from,
                          ['--via' as any]: topic.bg_color.bg_color_via,
            ...
            <div className="m-[40px] border border-white/20 rounded-2xl p-10 bg-[#272b39]">
             {movieCountryList.map((movie,rowIndex) =>(  
              <div key={movie.id} className="relative mb-[20px]">
               ...
               <div className="flex flex-wrap border border-white/50  gap-40 mt-10 justify-center rounded-2xl">
                  <div className="py-10">
                      <div className="flex gap-4">
                        <FaRankingStar className="text-[20px] text-[#ffd875]"></FaRankingStar>
                        <h2 className="text-[15px] font-bold">Nhiều người xem nhất</h2>
                      </div>
                       <div className="flex gap-4 mt-5 items-center">
                          <h3 className="text-[#aaaaaa]">1.</h3>
                          <Image src={'https://static.nutscdn.com/vimg/300-0/08cb698288836e180ef902e8129c2283.png'} alt="movie poster" width={30} height={10}  className=""></Image>
                          <h3 className="text-white">Trò Chơi Ảo Giác</h3>
                      </div>
                      <div className="flex gap-4 mt-5 items-center">
                          <h3 className="text-[#aaaaaa]">1.</h3>
                          <Image src={'https://static.nutscdn.com/vimg/300-0/08cb698288836e180ef902e8129c2283.png'} alt="movie poster" width={30} height={10}  className=""></Image>
                  ...
                  <div className="py-10">
                      <div className="flex gap-4">
                        <FaHeart className="text-[20px] text-[#ffd875]"></FaHeart>
                        <h2 className="text-[15px] font-bold">Phim được yêu thích</h2>
                      </div>
                      <div className="flex gap-4 mt-5 items-center">
                          <h3 className="text-[#aaaaaa]">1.</h3>
                          <Image src={'https://static.nutscdn.com/vimg/300-0/08cb698288836e180ef902e8129c2283.png'} alt="movie poster" width={30} height={10}  className=""></Image>
